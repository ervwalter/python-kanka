...
from kanka.exceptions import (
    ...
    ValidationError, RateLimitError, KankaException
)
from .utils import (
    create_mock_entity, create_api_response, 
    create_mock_search_result, MockResponse
)
...
class TestKankaClient:
    ...
    def test_manager_initialization(self):
        ...
        assert client.species is not None
        ...
        assert client.entity_notes is not None
        assert client.entity_events is not None
    ...
    def test_search_with_pagination(self, mock_session_class):
        ...
        # Create client and search
        client = KankaClient(token="test_token", campaign_id=123)
        results = client.search("test", page=3, limit=50)
