...
from kanka.exceptions import ValidationError
from .utils import (
    create_mock_entity, create_api_response, 
    create_mock_post, MockResponse
)
...
class TestEntityManager:
    ...
    def test_update_entity_by_object(self):
        ...
        self.mock_client._request.assert_called_with(
            'PATCH', 'characters/1',
            json={'name': 'New Name', 'title': 'New Title'}
        )
    ...
    def test_update_validation_error(self):
        ...
        result = self.manager.update(1, created_at="not a date")
